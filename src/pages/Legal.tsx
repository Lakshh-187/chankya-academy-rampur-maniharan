...
export default function Legal() {
  return (
    <>
      <SEO 
        title="Legal Information - Chanakya International Academy, Rampur Maniharan | CIARampur"
        description="Legal information, registration details, and compliance certificates of Chanakya International Academy, Rampur Maniharan under Baba Akhand Bharat Trust. CBSE affiliation and government recognition details."
        keywords="Chanakya International Academy legal, school registration, CBSE affiliation, Baba Akhand Bharat Trust, compliance certificates, government recognition"
        canonicalUrl="https://ciarampur.com/legal"
      />
